...
export default () => (
  <Page>
    ...
    <StyledQuote cite="https://medium.com/paypal-engineering/graphql-resolvers-best-practices-cd36fdbcef55">
      <p>The tree is executed breadth-first, meaning user must be resolved before its children name and email are executed. If the user resolver is asynchronous, the user branch delays until its resolved.</p>
      <footer>—Mark Stuart, <cite><a href="https://medium.com/paypal-engineering/graphql-resolvers-best-practices-cd36fdbcef55">GraphQL Resolvers: Best Practices</a></cite></footer>
    </StyledQuote>
    <StyledQuote cite="http://graphdatamodeling.com/Graph%20Data%20Modeling/GraphQL/GraphQL.html">
      <p>This means that the schema is not only a scope contract, but also the authoritative source of structure and meaning of the context covered by the API.</p>
      <footer>—Thomas Frisendal, <cite><a href="http://graphdatamodeling.com/Graph%20Data%20Modeling/GraphQL/GraphQL.html">GraphQL Design</a></cite></footer>
    </StyledQuote>
    <StyledQuote cite="https://graphql.org/learn/thinking-in-graphs/">
      <p>To build a good schema, examine the everyday language you use to describe your business.</p>
      <footer>—graphql.org, <cite><a href="https://graphql.org/learn/thinking-in-graphs/">Thinking in Graphs</a></cite></footer>
    </StyledQuote>
    <StyledQuote cite="https://graphql.org/learn/thinking-in-graphs/">
      <p>With GraphQL, you model your business domain as a graph ... to build a good schema, examine the everyday language you use to describe your business.</p>
      <footer>—graphql.org, <cite><a href="https://graphql.org/learn/thinking-in-graphs/">Thinking in Graphs</a></cite></footer>
    </StyledQuote>
    <StyledQuote cite="https://standards.rest/">
      <p>Don't reinvent the wheel, use fantastic wheels, hashed out by experts, that solve problems you hadn't even considered yet.</p>
      <footer>—<cite><a href="https://standards.rest/">standards.rest</a></cite></footer>
    </StyledQuote>
    <StyledQuote cite="https://www.ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm#sec_5_1_5">
      <p>The trade-off, though, is that a uniform interface degrades efficiency, since information is transferred in a standardized form rather than one which is specific to an application's needs. The REST interface is designed to be efficient for large-grain hypermedia data transfer, optimizing for the common case of the Web, but resulting in an interface that is not optimal for other forms of architectural interaction ...</p>
      <footer>—Roy Thomas Fielding, <cite><a href="https://www.ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm#sec_5_1_5">Representational State Transfer (REST)</a></cite></footer>
    </StyledQuote>
  </Page>
);
