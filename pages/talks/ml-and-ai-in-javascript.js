...
export default () => (
  <Page>
    ...
    <p>
      When my Dutch father handed me a stack of scans and digital records of the
      family history I thought: "How can I use the tools I have (JavaScript, in
      this case) to parse these documents and pull some data out?".
    </p>
    <p>
      This talk describes how I used Natural Language Processing and other tools
      to translate and find meaning in a bunch of documents.
    </p>
